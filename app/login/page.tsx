    ...
    <div className="flex items-center justify-center p-6 mt-30">
      <div className="bg-white rounded-3xl shadow-2xl shadow-[#576CA8] w-full max-w-7xl p-6 md:p-15 grid md:grid-cols-2 gap-8 md:gap-30">
        <div className="flex flex-col justify-center">
          ...
          <button className="w-full max-w-xs bg-[#274690] text-white py-3.5 rounded-lg text-lg font-medium hover:bg-[#1B264F] transition-colors mb-6 mx-auto" onClick={handleLogin}>
            Log in
          </button>
        ...
        <div className="bg-[#1B264F] rounded-2xl p-6 md:p-8 flex flex-col justify-center">
          ...
          <div className="space-y-4">
            <button className="w-full bg-white hover:bg-gray-200 text-gray-800 py-3.5 rounded-lg font-medium text-sm lg:text-2xl flex items-center md:gap-18 transition-colors" onClick={google_login}>
            ...
            <button className="w-full bg-white hover:bg-gray-200 text-gray-800 py-3.5 rounded-lg font-medium text-sm lg:text-2xl flex items-center md:gap-18 transition-colors" onClick={discord_login}>
            ...
            <button className="w-full bg-white hover:bg-gray-200 text-gray-800 py-3.5 rounded-lg font-medium text-sm lg:text-2xl flex items-center md:gap-18 transition-colors" onClick={github_login}>
            ...
            <button className="w-full bg-white hover:bg-gray-200 text-gray-800 py-3.5 rounded-lg font-medium text-sm lg:text-2xl flex items-center md:gap-18 transition-colors">
